    ...
    <div className="min-h-screen bg-[#0f1117] flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xs text-gray-400 mt-1">Sign in to your RAG Research Account</p>
        </div>
        ...
        <div className="mt-8 text-center text-xs">
          ...
          <Link to="/register" className="text-[#8b5cf6] font-semibold hover:text-[#a78bfa] transition-colors">
            Sign Up
          </Link>
        </div>
      </motion.div>
